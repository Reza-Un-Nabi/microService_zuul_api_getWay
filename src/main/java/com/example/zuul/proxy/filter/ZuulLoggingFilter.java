...
public class ZuulLoggingFilter {
	 ...
	 * return true; }
	 * 
	 * @Override public Object run() throws ZuulException { //getting the current
	 * HTTP request that is to be handle HttpServletRequest request=
	 * RequestContext.getCurrentContext().getRequest(); //printing the detail of the
	 * request logger.info("Logging................request -> {} request uri-> {}",
	 * request, request.getRequestURI()); return null; }
	 * 
	 * 
